...
var g = 0;
if(r >= 0) {
    alert(" The number of students label and the list you will make will be editable, just click on them to edit them ");
}
function on() {
    z  = 1;
    ...
    localStorage.i = i;
    localStorage.names_of_the_students = names_of_the_students;
